...
if __name__ == "__main__":
    ...
    parser.add_argument('--ibot_ckp_file', type=str,
                        default='./checkpoint.pth')  ### donot forget this argument for iBOT ckp path!!!!
    ...
    model = LPMFlow(
        feature_size=args_model.feature_size, ibot_ckp_file=args.ibot_ckp_file, depth=args_model.depth, num_heads=args_model.num_heads
